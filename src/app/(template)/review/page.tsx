    ...
    return (
        <div className='w-full h-full flex flex-col justify-center items-center px-[5%] xl:px-32 py-32'>
            <div className="header-content flex w-full flex-col justify-center items-center py-4">
                <h1 className="text-5xl md:text-6xl font-bold text-center">Global p<span className="relative">ro<img src="./images/acc-heading.svg" alt="play button" className={`${styleAcc}`} /></span>motion</h1>
